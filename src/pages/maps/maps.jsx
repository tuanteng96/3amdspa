...
export default class extends React.Component {
  ...
  componentDidMount() {
    ...
    NewsDataService.getBannerName("App.Maps")
      .then((response) => {
        const arrBanner = response.data.data;
        console.log(arrBanner[0].Desc);
        this.setState({
          arrMaps: arrBanner,
          currentMap: arrBanner[0].Desc,
          currentID: arrBanner[0].ID,
        });
      })
      .catch((e) => {
        console.log(e);
          ...
          <div className="page-render page-maps__box p-0">
            {currentMap && (
              <iframe
                src={
                  currentMap &&
                  currentMap.replaceAll("<p>", "").replaceAll("</p>", "")
                }
                frameBorder={0}
                allowFullScreen
                aria-hidden="false"
